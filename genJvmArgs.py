import sys
def usage():
  print "wsadmin.sh -lang jython -f genJvmArgs.py <add | remove> <jvm search> <partial arg name or full (if adding)> [save]"
  print ""
  print "Example: sudo ./wsadmin.sh -lang jython -f genJvmArgs.py add wps -Xmn320m"
